...
class Renderer
{
   private:
    ...
    void getShaders()
    {
        ...
        dispatch_data_t data = dispatch_data_create(g_metal_shader_lib_source, g_metal_shader_lib_source_size, nullptr,
                                                    ^void(void){
                                                    });
        ...
        MTL::Function *vertex_fn = m_library->newFunction(NS::String::string("rayVertex", NS::UTF8StringEncoding));
        MTL::Function *fragment_fn = m_library->newFunction(NS::String::string("rayFragment", NS::UTF8StringEncoding));
    ...
    void buildBuffers()
    {
        ...
        for (uint32_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
            m_instance_buf[i] = m_device->newBuffer(instance_buf_len, MTL::ResourceStorageModeManaged);
        }
   ...
   public:
    ...
    void Render(MTK::View *view)
    {
        ...
        MTL::RenderCommandEncoder *encoder = cmd_buffer->renderCommandEncoder(render_pass);
        ...
        encoder->drawIndexedPrimitives(MTL::PrimitiveType::PrimitiveTypeTriangle, NS::UInteger(6),
...
class ViewDelegate : public MTK::ViewDelegate
{
   ...
   public:
    ...
    virtual void drawInMTKView(MTK::View *view) override { renderer.Render(view); }
};
...
class AppDelegate : public NS::ApplicationDelegate
{
   ...
   public:
    ...
    virtual void applicationDidFinishLaunching(NS::Notification *notification) override
    {
        ...
        m_window = NS::Window::alloc()->init(frame, NS::WindowStyleMaskClosable | NS::WindowStyleMaskTitled,
