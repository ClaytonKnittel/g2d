...
static OSStatus
SineWaveRenderProc (void *inRefCon,
...
static void
BuildAudioComponentDescription(AudioComponentDescription *oAudioComponentDescription)
{
...
FindAudioComponent(AudioComponentDescription iAudioComponentDescription) {
	AudioComponent outputAudioUnit = AudioComponentFindNext(NULL, 
			&iAudioComponentDescription);
	if (!outputAudioUnit) {
...
static void
StopAudioOutputUnit(AudioUnit inAudioUnit)
{
